...
```
funredun(spDat, funDat, method = "bray")
```
...
method | Default is Bray-Curtis dissimilarity. Available options include "bray", "gower", and "altGower". See <a href="https://cran.r-project.org/web/packages/vegan/index.html">vegan::vegdist</a> for details.
